<template>
    <main class="flex flex-col p-5 items-start">
        <h2 class="text-2xl">FAQ Schema</h2>
        <div v-for="question in schema.mainEntity" class="m-2">
...
export default {
    ...
    methods: {
        addQuestion() {
            this.schema.mainEntity.push({ "@type": "Question", "name":'', "acceptedAnswer": { "@type": "Answer" } })
        }
    }
}
</script>